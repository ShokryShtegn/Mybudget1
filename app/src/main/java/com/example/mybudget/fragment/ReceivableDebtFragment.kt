 ...
 * created by Isra
 */
class ReceivableDebtFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view: View = inflater.inflate(R.layout.fragment_receivable_debt, container, false)
    ...
    fun readFromLocalStorage() {
        ...
        val cursor: Cursor? =  dataBaseHandler.getDebts(Global.USER_ID)
        debtsList.clear()
